...
int32_T Robot_d2dba219_3_ds_dtf(const NeDynamicSystem *t0, const
  NeDynamicSystemInput *t134, NeDsMethodOutput *t135)
{
  ...
  intermediate_der100 = -X_idx_11 + X_idx_8;
  ...
  out.mX[0] = -(((((((intermediate_der100 - d_efOut[0] * U_idx_0 * 7.0) *
    ...
    * U_idx_0 * 7.0) * X_idx_0) + -(t41 * U_idx_0 * 7.0) * t45) + (t92 -
    b_efOut[0] * U_idx_0 * 7.0) * t58) + -(t43 * U_idx_0 * 7.0) * t46) *
                1.732050807568877);
  out.mX[1] = -(((((((intermediate_der100 - d_efOut[0] * U_idx_0 * 7.0) * t59 +
