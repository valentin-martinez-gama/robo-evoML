...
int32_T Robot_d2dba219_2_ds_dxf(const NeDynamicSystem *t0, const
  NeDynamicSystemInput *t220, NeDsMethodOutput *t221)
{
  ...
  intermediate_der92 = -X_idx_11 + X_idx_9;
  ...
  X_idx_8 = (-(cos(intrm_sf_mf_17 + 2.0943951023931953) * 7.0) * (X_idx_10 /
              (X_idx_0 == 0.0 ? 1.0E-16 : X_idx_0)) * t189 + -(-sin
              (intrm_sf_mf_17 + 2.0943951023931953) * 7.0) * (t183 / (X_idx_0 ==
    0.0 ? 1.0E-16 : X_idx_0))) * (real_T)(M_idx_25 != 0) + -(-(cos
    (intrm_sf_mf_17 + 2.0943951023931953) * 7.0) * (X_idx_10 / (X_idx_0 == 0.0 ?
    1.0E-16 : X_idx_0)) * t206 + -(-sin(intrm_sf_mf_17 + 2.0943951023931953) *
    7.0) * (t183 / (X_idx_0 == 0.0 ? 1.0E-16 : X_idx_0))) * (real_T)(M_idx_25 ==
    0);
  _in1ivar = 8ULL;
  ...
  X_idx_8 = (-(cos(intrm_sf_mf_17) * 7.0) * (t189 / (t206 == 0.0 ? 1.0E-16 :
    t206)) * X_idx_0 + -(-sin(intrm_sf_mf_17) * 7.0) * (t191 / (t206 == 0.0 ?
    1.0E-16 : t206))) * (real_T)(M_idx_23 != 0) + -(-(cos(intrm_sf_mf_17) * 7.0)
    * (t189 / (t206 == 0.0 ? 1.0E-16 : t206)) * t183 + -(-sin(intrm_sf_mf_17) *
    7.0) * (t191 / (t206 == 0.0 ? 1.0E-16 : t206))) * (real_T)(M_idx_23 == 0);
  _in1ivar = 8ULL;
  ...
  X_idx_8 = (-(cos(intrm_sf_mf_17 + -2.0943951023931953) * 7.0) * (X_idx_0 /
              (t183 == 0.0 ? 1.0E-16 : t183)) * X_idx_9 + -(-sin(intrm_sf_mf_17
    + -2.0943951023931953) * 7.0) * (X_idx_8 / (t183 == 0.0 ? 1.0E-16 : t183))) *
    (real_T)(M_idx_24 != 0) + -(-(cos(intrm_sf_mf_17 + -2.0943951023931953) *
    7.0) * (X_idx_0 / (t183 == 0.0 ? 1.0E-16 : t183)) * X_idx_10 + -(-sin
    (intrm_sf_mf_17 + -2.0943951023931953) * 7.0) * (X_idx_8 / (t183 == 0.0 ?
    1.0E-16 : t183))) * (real_T)(M_idx_24 == 0);
  _in1ivar = 8ULL;
  ...
  X_idx_9 = (((((t160 - d_efOut[0] * U_idx_0 * 7.0) * t115 + -(t91 * U_idx_0 *
    7.0) * t94) + (intermediate_der92 - f_efOut[0] * U_idx_0 * 7.0) * t116) +
              -(X_idx_8 * U_idx_0 * 7.0) * t95) + (intermediate_der95 - b_efOut
              [0] * U_idx_0 * 7.0) * t117) + -(t156 * U_idx_0 * 7.0) * t96;
  t115 = t96;
  t116 = (-t94 + -t95) + -t96;
  t96 = (((((t160 - d_efOut[0] * U_idx_0 * 7.0) * t118 + -(t91 * U_idx_0 * 7.0) *
            t97) + (intermediate_der92 - f_efOut[0] * U_idx_0 * 7.0) * t119) +
          -(X_idx_8 * U_idx_0 * 7.0) * t98) + (intermediate_der95 - b_efOut[0] *
          U_idx_0 * 7.0) * t120) + -(t156 * U_idx_0 * 7.0) * t99;
  t160 = t99;
  intermediate_der92 = (-t97 + -t98) + -t99;
  intermediate_der95 = t98;
  if (M_idx_26 != 0) {
    t98 = -1000.0;
  } else if (M_idx_2 != 0) {
  ...
  t34[4ULL] = -((X_idx_2 * 3.0200000000000002E-5 - X_idx_2 *
                 3.0200000000000002E-5) * 10.5);
  t35[0ULL] = -(t94 * 1.732050807568877);
  t35[1ULL] = -(t97 * 1.5);
  t35[2ULL] = t98;
  t35[3ULL] = t99;
  t35[4ULL] = t117;
  t35[5ULL] = t118;
  t36[0ULL] = -(t95 * 1.732050807568877);
  t36[1ULL] = -(intermediate_der95 * 1.5);
  t36[2ULL] = t119;
  t36[3ULL] = t120;
  t36[4ULL] = X_idx_10;
  t36[5ULL] = X_idx_0;
  t37[0ULL] = -(t115 * 1.732050807568877);
  t37[1ULL] = -(t160 * 1.5);
  t37[2ULL] = t183;
  t37[3ULL] = t189;
  t37[4ULL] = t206;
  t37[5ULL] = t191;
  t38[0ULL] = -(t116 * 1.732050807568877);
  t38[1ULL] = -(intermediate_der92 * 1.5);
