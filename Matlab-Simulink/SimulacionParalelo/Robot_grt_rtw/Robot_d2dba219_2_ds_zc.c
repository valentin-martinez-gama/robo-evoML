...
int32_T Robot_d2dba219_2_ds_zc(const NeDynamicSystem *t0, const
  NeDynamicSystemInput *t21, NeDsMethodOutput *t22)
{
  ...
  t18 = t1;
  t19 = t1 + -2.0943951023931953;
  X_idx_0 = t1 + 2.0943951023931953;
  if (M_idx_17 == 0) {
    t1 = -pmf_get_inf() - (-X_idx_10);
  } else {
    t1 = 0.0;
  }
  ...
  if (M_idx_4 == 0) {
    t12 = -pmf_get_inf() - (-X_idx_8);
  } else {
    t12 = 0.0;
  }

  t13_idx_11 = -sin(X_idx_0);
  t19 = -sin(t19);
  X_idx_0 = -sin(t18);
  out.mX[0] = t1;
  out.mX[1] = -X_idx_10 - 0.8;
  out.mX[2] = (real_T)t2;
  out.mX[3] = t15;
  out.mX[4] = (X_idx_10 + -24.0) - 0.8;
  out.mX[5] = (real_T)t4;
  ...
  out.mX[9] = (real_T)t7;
  out.mX[10] = t17;
  out.mX[11] = t13_idx_11;
  out.mX[12] = t19;
  out.mX[13] = t9;
  out.mX[14] = (real_T)t10;
  out.mX[15] = X_idx_0;
  out.mX[16] = (U_idx_5 - 0.5) - ((-X_idx_10 + 24.0) - 0.8);
  out.mX[17] = (U_idx_4 - 0.5) - (X_idx_9 - 0.8);
  out.mX[18] = (X_idx_8 + -24.0) - 0.8;
  out.mX[19] = (U_idx_3 - 0.5) - ((-X_idx_9 + 24.0) - 0.8);
  out.mX[20] = (real_T)t11;
  out.mX[21] = (U_idx_6 - 0.5) - (X_idx_10 - 0.8);
  out.mX[22] = (U_idx_2 - 0.5) - (X_idx_8 - 0.8);
  out.mX[23] = (U_idx_1 - 0.5) - ((-X_idx_8 + 24.0) - 0.8);
  out.mX[24] = (X_idx_9 + -24.0) - 0.8;
  out.mX[25] = -X_idx_8 - 0.8;
  out.mX[26] = t12;
  (void)t0;
  (void)t22;
  return 0;
