 ...
 */
/* Robot_d2dba219_3_ds.c - body for module Robot_d2dba219_3_ds */

#include "ne_ds.h"
#include "Robot_d2dba219_3_ds_zc.h"
#include "Robot_d2dba219_3_ds_tdxy_p.h"
#include "Robot_d2dba219_3_ds_dxy_p.h"
#include "Robot_d2dba219_3_ds_obs_il.h"
#include "Robot_d2dba219_3_ds_obs_all.h"
#include "Robot_d2dba219_3_ds_obs_act.h"
#include "Robot_d2dba219_3_ds_obs_exp.h"
#include "Robot_d2dba219_3_ds_m_p.h"
#include "Robot_d2dba219_3_ds_log.h"
#include "Robot_d2dba219_3_ds_dnf_p.h"
#include "Robot_d2dba219_3_ds_tdxf_p.h"
#include "Robot_d2dba219_3_ds_a_p.h"
#include "Robot_d2dba219_3_ds_dxf_p.h"
#include "Robot_d2dba219_3_ds_dxf.h"
#include "Robot_d2dba219_3_ds_mode.h"
#include "Robot_d2dba219_3_ds_f.h"
#include "Robot_d2dba219_3_ds_duf.h"
#include "Robot_d2dba219_3_ds_dtf.h"
#include "Robot_d2dba219_3_ds_assert.h"
...
static NeEquationData s_equation_data[24] = { { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "Robot/BLDC1", 2U, 0U, TRUE, 1.0, "1", }, { "", 0U,
    8, NE_EQUATION_DOMAIN_TIME, "Robot/BLDC1", 1U, 2U, FALSE, 1.0, "1", }, { "",
    0U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/BLDC1", 1U, 3U, FALSE, 1.0, "1", }, {
    "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/BLDC1", 1U, 4U, FALSE, 1.0, "1",
  }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/BLDC1", 2U, 5U, FALSE, 1.0,
    "1", }, { "", 1U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/BLDC1", 2U, 5U, FALSE,
    1.0, "1", }, { "", 2U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/BLDC1", 2U, 5U,
    FALSE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Robot/Motion  Sensor1", 2U, 7U, TRUE, 1.0, "1", }, { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "Robot/BLDC1", 1U, 9U, FALSE, 1.0, "1", }, { "", 0U,
    8, NE_EQUATION_DOMAIN_TIME, "Robot/BLDC1", 1U, 10U, FALSE, 1.0, "1", }, { "",
    0U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/BLDC1", 1U, 11U, FALSE, 1.0, "1", },
    { "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/BLDC1", 1U, 12U, FALSE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/Inverter1", 5U, 13U,
    TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/Inverter1",
    3U, 18U, TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Robot/Inverter1", 5U, 21U, TRUE, 1.0, "1", }, { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "Robot/Inverter1", 3U, 26U, TRUE, 1.0, "1", }, { "",
    0U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/Inverter1", 5U, 29U, TRUE, 1.0, "1",
  }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/Inverter1", 3U, 34U, TRUE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/Inverter1", 5U, 37U,
    TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/Inverter1",
    3U, 42U, TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Robot/Inverter1", 5U, 45U, TRUE, 1.0, "1", }, { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "Robot/Inverter1", 3U, 50U, TRUE, 1.0, "1", }, { "",
    0U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/Inverter1", 5U, 53U, TRUE, 1.0, "1",
  }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME, "Robot/Inverter1", 3U, 58U, TRUE, 1.0,
    "1", } };

static NeICRData s_icr_data[2] = { { "", 0U, 0, "Robot/BLDC1", 1U, 0U, }, { "",
    0U, 0, "Robot/BLDC1", 1U, 1U, } };

static NeVariableData s_variable_data[24] = { {
    "BLDC1.pm_dq0_Xabc.angular_position_diff", 0U, 0, "Robot/BLDC1", 1.0, "1",
    0.0, TRUE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "angular_position_diff", }, {
    "BLDC1.pm_dq0_Xabc.i_0", 0U, 0, "Robot/BLDC1", 1.0, "1", 0.0, TRUE, FALSE,
    1U, 1U, NE_INIT_MODE_MANDATORY, "Zero-sequence current", }, {
    "BLDC1.pm_dq0_Xabc.i_d", 0U, 0, "Robot/BLDC1", 1.0, "1", 0.0, TRUE, FALSE,
    1U, 1U, NE_INIT_MODE_NONE, "D-axis current", }, { "BLDC1.pm_dq0_Xabc.i_q",
    0U, 0, "Robot/BLDC1", 1.0, "1", 0.0, TRUE, FALSE, 1U, 1U, NE_INIT_MODE_NONE,
    "Q-axis current", }, { "BLDC1.pm_dq0_Xabc.phi", 0U, 0, "Robot/BLDC1", 1.0,
    "1", 0.0, TRUE, FALSE, 1U, 3U, NE_INIT_MODE_NONE, "phi", }, {
    "BLDC1.pm_dq0_Xabc.phi", 1U, 0, "Robot/BLDC1", 1.0, "1", 0.0, TRUE, FALSE,
    1U, 3U, NE_INIT_MODE_NONE, "phi", }, { "BLDC1.pm_dq0_Xabc.phi", 2U, 0,
    "Robot/BLDC1", 1.0, "1", 0.0, TRUE, FALSE, 1U, 3U, NE_INIT_MODE_NONE, "phi",
  }, { "Motion_Sensor1.phi", 0U, 0, "Robot/Motion  Sensor1", 1.0, "1", 0.0, TRUE,
    FALSE, 1U, 1U, NE_INIT_MODE_MANDATORY, "Angle", }, {
    "Inverter1.converter_Xabc.Q1.E.v", 0U, 1, "Robot/Inverter1", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q3.E.v", 0U, 1, "Robot/Inverter1", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q5.E.v", 0U, 1, "Robot/Inverter1", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Voltage", }, { "BLDC1.n.v", 0U, 1,
    "Robot/BLDC1", 1.0, "1", 0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE,
    "Voltage", }, { "BLDC1.phase_splitter.i_b", 0U, 0, "Robot/BLDC1", 1.0, "1",
    0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "i_b", }, {
    "BLDC1.phase_splitter.i_c", 0U, 0, "Robot/BLDC1", 1.0, "1", 0.0, FALSE,
    FALSE, 1U, 1U, NE_INIT_MODE_NONE, "i_c", }, {
    "BLDC1.pm_dq0_Xabc.electrical_torque", 0U, 0, "Robot/BLDC1", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Electrical torque", }, {
    "Inverter1.converter_Xabc.Q2.diode.i", 0U, 0, "Robot/Inverter1", 1.0, "1",
    0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Current", }, {
    "Inverter1.converter_Xabc.Q2.ideal_switch.i", 0U, 0, "Robot/Inverter1", 1.0,
    "1", 0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "i", }, {
    "Inverter1.converter_Xabc.Q4.diode.i", 0U, 0, "Robot/Inverter1", 1.0, "1",
    0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Current", }, {
    "Inverter1.converter_Xabc.Q4.ideal_switch.i", 0U, 0, "Robot/Inverter1", 1.0,
    "1", 0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "i", }, {
    "Inverter1.converter_Xabc.Q6.diode.i", 0U, 0, "Robot/Inverter1", 1.0, "1",
    0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Current", }, {
    "Inverter1.converter_Xabc.Q6.ideal_switch.i", 0U, 0, "Robot/Inverter1", 1.0,
    "1", 0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "i", }, {
    "Inverter1.converter_Xabc.Q1.ideal_switch.i", 0U, 0, "Robot/Inverter1", 1.0,
    "1", 0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "i", }, {
    "Inverter1.converter_Xabc.Q3.ideal_switch.i", 0U, 0, "Robot/Inverter1", 1.0,
    "1", 0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "i", }, {
    "Inverter1.converter_Xabc.Q5.ideal_switch.i", 0U, 0, "Robot/Inverter1", 1.0,
    "1", 0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "i", } };

static NeVariableData *s_discrete_data = NULL;
static NeObservableData s_observable_data[250] = { { "BLDC1.C.w", "Robot/BLDC1",
    ...
    "BLDC1.N.V", "Robot/BLDC1", 1U, 3U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", },
    { "BLDC1.R.w", "Robot/BLDC1", 1U, 1U, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "BLDC1.angular_position", "Robot/BLDC1", 1U, 1U, "deg", 1.0, "1",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_MANDATORY, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotor angle", }, {
    "BLDC1.angular_velocity", "Robot/BLDC1", 1U, 1U, "rpm", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_MANDATORY, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotor speed", }, { "BLDC1.i_d",
    "Robot/BLDC1", 1U, 1U, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "D-axis current", }, { "BLDC1.i_q", "Robot/BLDC1", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Q-axis current", }, { "BLDC1.n.v",
    "Robot/BLDC1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Voltage", }, { "BLDC1.phase_splitter.I", "Robot/BLDC1", 1U, 3U, "A", 1.0,
    "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, { "BLDC1.phase_splitter.N.V",
    "Robot/BLDC1", 1U, 3U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", },
    { "BLDC1.phase_splitter.a.v", "Robot/BLDC1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "BLDC1.phase_splitter.b.v", "Robot/BLDC1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "BLDC1.phase_splitter.c.v", "Robot/BLDC1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "BLDC1.phase_splitter.i_a", "Robot/BLDC1", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i_a", }, { "BLDC1.phase_splitter.i_b",
    "Robot/BLDC1", 1U, 1U, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i_b", },
  { "BLDC1.phase_splitter.i_c", "Robot/BLDC1", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i_c", }, { "BLDC1.pm_dq0_Xabc.C.w",
    "Robot/BLDC1", 1U, 1U, "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Rotational velocity", }, { "BLDC1.pm_dq0_Xabc.R.w", "Robot/BLDC1", 1U, 1U,
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "BLDC1.pm_dq0_Xabc.a.v", "Robot/BLDC1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "BLDC1.pm_dq0_Xabc.angular_position", "Robot/BLDC1", 1U, 1U, "deg", 1.0, "1",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotor angle", }, {
    "BLDC1.pm_dq0_Xabc.angular_position_diff", "Robot/BLDC1", 1U, 1U, "rad", 1.0,
    "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "angular_position_diff", }, {
    "BLDC1.pm_dq0_Xabc.angular_velocity", "Robot/BLDC1", 1U, 1U, "rpm", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotor speed", }, {
    "BLDC1.pm_dq0_Xabc.b.v", "Robot/BLDC1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "BLDC1.pm_dq0_Xabc.c.v",
    "Robot/BLDC1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Voltage", }, { "BLDC1.pm_dq0_Xabc.electrical_torque", "Robot/BLDC1", 1U, 1U,
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Electrical torque", }, {
    "BLDC1.pm_dq0_Xabc.i_0", "Robot/BLDC1", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Zero-sequence current", }, {
    "BLDC1.pm_dq0_Xabc.i_a", "Robot/BLDC1", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i_a", }, { "BLDC1.pm_dq0_Xabc.i_b",
    "Robot/BLDC1", 1U, 1U, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i_b", },
  { "BLDC1.pm_dq0_Xabc.i_c", "Robot/BLDC1", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i_c", }, { "BLDC1.pm_dq0_Xabc.i_d",
    "Robot/BLDC1", 1U, 1U, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, TRUE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "D-axis current", }, { "BLDC1.pm_dq0_Xabc.i_n", "Robot/BLDC1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i_n", }, { "BLDC1.pm_dq0_Xabc.i_q",
    "Robot/BLDC1", 1U, 1U, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, TRUE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Q-axis current", }, { "BLDC1.pm_dq0_Xabc.n.v", "Robot/BLDC1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "BLDC1.pm_dq0_Xabc.phi",
    "Robot/BLDC1", 1U, 3U, "s*V", 1.0, "m^2*kg/s/C", NE_NOMINAL_SOURCE_DERIVED,
    NE_INIT_MODE_NONE, FALSE, TRUE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "phi", },
  { "BLDC1.pm_dq0_Xabc.power_dissipated", "Robot/BLDC1", 1U, 1U, "W", 1.0, "kW",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Power dissipated", }, {
    "BLDC1.pm_dq0_Xabc.torque", "Robot/BLDC1", 1U, 1U, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, { "BLDC1.pm_dq0_Xabc.v_a",
    "Robot/BLDC1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "v_a", },
  { "BLDC1.pm_dq0_Xabc.v_b", "Robot/BLDC1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "v_b", }, { "BLDC1.pm_dq0_Xabc.v_c",
    "Robot/BLDC1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "v_c", },
  { "BLDC1.pm_dq0_Xabc.x_Ld", "Robot/BLDC1", 1U, 1U, "H", 1.0e-6, "H",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "x_Ld", }, { "BLDC1.pm_dq0_Xabc.x_Lq",
    "Robot/BLDC1", 1U, 1U, "H", 1.0e-6, "H", NE_NOMINAL_SOURCE_NONE,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "x_Lq",
  }, { "BLDC1.torque", "Robot/BLDC1", 1U, 1U, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, { "DC_Voltage_Source1.i",
    "Robot/DC Voltage  Source1", 1U, 1U, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Current", }, { "DC_Voltage_Source1.n.v", "Robot/DC Voltage  Source1", 1U,
    1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "DC_Voltage_Source1.p.v",
    "Robot/DC Voltage  Source1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage",
  }, { "DC_Voltage_Source1.v", "Robot/DC Voltage  Source1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "ERef_Converter1.V.v",
    "Robot/ERef Converter1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage",
  }, { "ERef_IPMSM1.V.v", "Robot/ERef IPMSM1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Gate_driver1.G.V",
    "Robot/Gate driver1", 1U, 12U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "V", },
  { "Gate_driver1.Six_Pulse_Gate_Multiplexer.GaH",
    "Robot/Gate driver1/Six-Pulse Gate Multiplexer", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_FIXED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Ga(H)", }, {
    "Gate_driver1.Six_Pulse_Gate_Multiplexer.GaL",
    "Robot/Gate driver1/Six-Pulse Gate Multiplexer", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_FIXED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Ga(L)", }, {
    "Gate_driver1.Six_Pulse_Gate_Multiplexer.GbH",
    "Robot/Gate driver1/Six-Pulse Gate Multiplexer", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_FIXED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Gb(H)", }, {
    "Gate_driver1.Six_Pulse_Gate_Multiplexer.GbL",
    "Robot/Gate driver1/Six-Pulse Gate Multiplexer", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_FIXED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Gb(L)", }, {
    "Gate_driver1.Six_Pulse_Gate_Multiplexer.GcH",
    "Robot/Gate driver1/Six-Pulse Gate Multiplexer", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_FIXED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Gc(H)", }, {
    "Gate_driver1.Six_Pulse_Gate_Multiplexer.GcL",
    "Robot/Gate driver1/Six-Pulse Gate Multiplexer", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_FIXED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Gc(L)", }, {
    "Gate_driver1.Six_Pulse_Gate_Multiplexer.I",
    "Robot/Gate driver1/Six-Pulse Gate Multiplexer", 1U, 12U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, {
    "Gate_driver1.Six_Pulse_Gate_Multiplexer.p.V",
    "Robot/Gate driver1/Six-Pulse Gate Multiplexer", 1U, 12U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", }, { "Gmin1.i", "Robot/Gmin1", 1U,
    1U, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, { "Gmin1.n.v",
    "Robot/Gmin1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Voltage", }, { "Gmin1.p.v", "Robot/Gmin1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Gmin1.v", "Robot/Gmin1",
    1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Ideal_Angular_Velocity_Source1.C.w", "Robot/Ideal Angular Velocity Source1",
    1U, 1U, "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Angular_Velocity_Source1.R.w", "Robot/Ideal Angular Velocity Source1",
    1U, 1U, "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Ideal_Angular_Velocity_Source1.S", "Robot/Ideal Angular Velocity Source1",
    1U, 1U, "rad/s", 1.0, "rad/s", NE_NOMINAL_SOURCE_FIXED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "S", }, {
    "Ideal_Angular_Velocity_Source1.t", "Robot/Ideal Angular Velocity Source1",
    1U, 1U, "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, {
    "Ideal_Angular_Velocity_Source1.w", "Robot/Ideal Angular Velocity Source1",
    1U, 1U, "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Angular velocity", }, {
    "Inverter1.G.V", "Robot/Inverter1", 1U, 12U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", }, { "Inverter1.N.V",
    "Robot/Inverter1", 1U, 3U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", },
    { "Inverter1.converter_Xabc.G.V", "Robot/Inverter1", 1U, 12U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", }, {
    "Inverter1.converter_Xabc.Q1.C.v", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q1.E.v", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q1.G", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "G", }, {
    "Inverter1.converter_Xabc.Q1.diode.Tsim", "Robot/Inverter1", 1U, 1U, "K",
    1.0, "K", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Tsim", }, {
    "Inverter1.converter_Xabc.Q1.diode.i", "Robot/Inverter1", 1U, 1U, "A", 1.0,
    "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "Inverter1.converter_Xabc.Q1.diode.i_capacitor", "Robot/Inverter1", 1U, 1U,
    "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Junction capacitance current", }, {
    "Inverter1.converter_Xabc.Q1.diode.n.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q1.diode.p.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q1.diode.power_dissipated", "Robot/Inverter1", 1U,
    1U, "W", 1.0, "kW", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "power_dissipated", }, {
    "Inverter1.converter_Xabc.Q1.diode.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q1.diode.v_capacitor", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Junction capacitance voltage", }, {
    "Inverter1.converter_Xabc.Q1.ideal_switch.G", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "PS", }, {
    "Inverter1.converter_Xabc.Q1.ideal_switch.i", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i", }, {
    "Inverter1.converter_Xabc.Q1.ideal_switch.isOn", "Robot/Inverter1", 1U, 1U,
    "1", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "isOn", }, {
    "Inverter1.converter_Xabc.Q1.ideal_switch.n.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q1.ideal_switch.p.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q1.ideal_switch.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "v", }, {
    "Inverter1.converter_Xabc.Q1.ideal_switch.power_dissipated",
    "Robot/Inverter1", 1U, 1U, "W", 1.0, "kW", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Power dissipated", }, { "Inverter1.converter_Xabc.Q2.C.v",
    "Robot/Inverter1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Voltage", }, { "Inverter1.converter_Xabc.Q2.E.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q2.G", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "G", }, {
    "Inverter1.converter_Xabc.Q2.diode.Tsim", "Robot/Inverter1", 1U, 1U, "K",
    1.0, "K", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Tsim", }, {
    "Inverter1.converter_Xabc.Q2.diode.i", "Robot/Inverter1", 1U, 1U, "A", 1.0,
    "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "Inverter1.converter_Xabc.Q2.diode.i_capacitor", "Robot/Inverter1", 1U, 1U,
    "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Junction capacitance current", }, {
    "Inverter1.converter_Xabc.Q2.diode.n.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q2.diode.p.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q2.diode.power_dissipated", "Robot/Inverter1", 1U,
    1U, "W", 1.0, "kW", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "power_dissipated", }, {
    "Inverter1.converter_Xabc.Q2.diode.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q2.diode.v_capacitor", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Junction capacitance voltage", }, {
    "Inverter1.converter_Xabc.Q2.ideal_switch.G", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "PS", }, {
    "Inverter1.converter_Xabc.Q2.ideal_switch.i", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i", }, {
    "Inverter1.converter_Xabc.Q2.ideal_switch.isOn", "Robot/Inverter1", 1U, 1U,
    "1", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "isOn", }, {
    "Inverter1.converter_Xabc.Q2.ideal_switch.n.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q2.ideal_switch.p.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q2.ideal_switch.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "v", }, {
    "Inverter1.converter_Xabc.Q2.ideal_switch.power_dissipated",
    "Robot/Inverter1", 1U, 1U, "W", 1.0, "kW", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Power dissipated", }, { "Inverter1.converter_Xabc.Q3.C.v",
    "Robot/Inverter1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage",
  }, { "Inverter1.converter_Xabc.Q3.E.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q3.G", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "G", }, {
    "Inverter1.converter_Xabc.Q3.diode.Tsim", "Robot/Inverter1", 1U, 1U, "K",
    1.0, "K", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Tsim", }, {
    "Inverter1.converter_Xabc.Q3.diode.i", "Robot/Inverter1", 1U, 1U, "A", 1.0,
    "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "Inverter1.converter_Xabc.Q3.diode.i_capacitor", "Robot/Inverter1", 1U, 1U,
    "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Junction capacitance current", }, {
    "Inverter1.converter_Xabc.Q3.diode.n.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q3.diode.p.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q3.diode.power_dissipated", "Robot/Inverter1", 1U,
    1U, "W", 1.0, "kW", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "power_dissipated", }, {
    "Inverter1.converter_Xabc.Q3.diode.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q3.diode.v_capacitor", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Junction capacitance voltage", }, {
    "Inverter1.converter_Xabc.Q3.ideal_switch.G", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "PS", }, {
    "Inverter1.converter_Xabc.Q3.ideal_switch.i", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i", }, {
    "Inverter1.converter_Xabc.Q3.ideal_switch.isOn", "Robot/Inverter1", 1U, 1U,
    "1", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "isOn", }, {
    "Inverter1.converter_Xabc.Q3.ideal_switch.n.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q3.ideal_switch.p.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q3.ideal_switch.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "v", }, {
    "Inverter1.converter_Xabc.Q3.ideal_switch.power_dissipated",
    "Robot/Inverter1", 1U, 1U, "W", 1.0, "kW", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Power dissipated", }, { "Inverter1.converter_Xabc.Q4.C.v",
    "Robot/Inverter1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Voltage", }, { "Inverter1.converter_Xabc.Q4.E.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q4.G", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "G", }, {
    "Inverter1.converter_Xabc.Q4.diode.Tsim", "Robot/Inverter1", 1U, 1U, "K",
    1.0, "K", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Tsim", }, {
    "Inverter1.converter_Xabc.Q4.diode.i", "Robot/Inverter1", 1U, 1U, "A", 1.0,
    "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "Inverter1.converter_Xabc.Q4.diode.i_capacitor", "Robot/Inverter1", 1U, 1U,
    "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Junction capacitance current", }, {
    "Inverter1.converter_Xabc.Q4.diode.n.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q4.diode.p.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q4.diode.power_dissipated", "Robot/Inverter1", 1U,
    1U, "W", 1.0, "kW", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "power_dissipated", }, {
    "Inverter1.converter_Xabc.Q4.diode.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q4.diode.v_capacitor", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Junction capacitance voltage", }, {
    "Inverter1.converter_Xabc.Q4.ideal_switch.G", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "PS", }, {
    "Inverter1.converter_Xabc.Q4.ideal_switch.i", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i", }, {
    "Inverter1.converter_Xabc.Q4.ideal_switch.isOn", "Robot/Inverter1", 1U, 1U,
    "1", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "isOn", }, {
    "Inverter1.converter_Xabc.Q4.ideal_switch.n.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q4.ideal_switch.p.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q4.ideal_switch.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "v", }, {
    "Inverter1.converter_Xabc.Q4.ideal_switch.power_dissipated",
    "Robot/Inverter1", 1U, 1U, "W", 1.0, "kW", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Power dissipated", }, { "Inverter1.converter_Xabc.Q5.C.v",
    "Robot/Inverter1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage",
  }, { "Inverter1.converter_Xabc.Q5.E.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q5.G", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "G", }, {
    "Inverter1.converter_Xabc.Q5.diode.Tsim", "Robot/Inverter1", 1U, 1U, "K",
    1.0, "K", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Tsim", }, {
    "Inverter1.converter_Xabc.Q5.diode.i", "Robot/Inverter1", 1U, 1U, "A", 1.0,
    "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "Inverter1.converter_Xabc.Q5.diode.i_capacitor", "Robot/Inverter1", 1U, 1U,
    "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Junction capacitance current", }, {
    "Inverter1.converter_Xabc.Q5.diode.n.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q5.diode.p.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q5.diode.power_dissipated", "Robot/Inverter1", 1U,
    1U, "W", 1.0, "kW", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "power_dissipated", }, {
    "Inverter1.converter_Xabc.Q5.diode.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q5.diode.v_capacitor", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Junction capacitance voltage", }, {
    "Inverter1.converter_Xabc.Q5.ideal_switch.G", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "PS", }, {
    "Inverter1.converter_Xabc.Q5.ideal_switch.i", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i", }, {
    "Inverter1.converter_Xabc.Q5.ideal_switch.isOn", "Robot/Inverter1", 1U, 1U,
    "1", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "isOn", }, {
    "Inverter1.converter_Xabc.Q5.ideal_switch.n.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q5.ideal_switch.p.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q5.ideal_switch.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "v", }, {
    "Inverter1.converter_Xabc.Q5.ideal_switch.power_dissipated",
    "Robot/Inverter1", 1U, 1U, "W", 1.0, "kW", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Power dissipated", }, { "Inverter1.converter_Xabc.Q6.C.v",
    "Robot/Inverter1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Voltage", }, { "Inverter1.converter_Xabc.Q6.E.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q6.G", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "G", }, {
    "Inverter1.converter_Xabc.Q6.diode.Tsim", "Robot/Inverter1", 1U, 1U, "K",
    1.0, "K", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Tsim", }, {
    "Inverter1.converter_Xabc.Q6.diode.i", "Robot/Inverter1", 1U, 1U, "A", 1.0,
    "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "Inverter1.converter_Xabc.Q6.diode.i_capacitor", "Robot/Inverter1", 1U, 1U,
    "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Junction capacitance current", }, {
    "Inverter1.converter_Xabc.Q6.diode.n.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q6.diode.p.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q6.diode.power_dissipated", "Robot/Inverter1", 1U,
    1U, "W", 1.0, "kW", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "power_dissipated", }, {
    "Inverter1.converter_Xabc.Q6.diode.v", "Robot/Inverter1", 1U, 1U, "V", 1.0,
    "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q6.diode.v_capacitor", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Junction capacitance voltage", }, {
    "Inverter1.converter_Xabc.Q6.ideal_switch.G", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "PS", }, {
    "Inverter1.converter_Xabc.Q6.ideal_switch.i", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i", }, {
    "Inverter1.converter_Xabc.Q6.ideal_switch.isOn", "Robot/Inverter1", 1U, 1U,
    "1", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "isOn", }, {
    "Inverter1.converter_Xabc.Q6.ideal_switch.n.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q6.ideal_switch.p.v", "Robot/Inverter1", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.Q6.ideal_switch.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "v", }, {
    "Inverter1.converter_Xabc.Q6.ideal_switch.power_dissipated",
    "Robot/Inverter1", 1U, 1U, "W", 1.0, "kW", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Power dissipated", }, { "Inverter1.converter_Xabc.a.v", "Robot/Inverter1",
    1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.b.v", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.c.v", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.demux_gates.G1", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "G1", }, {
    "Inverter1.converter_Xabc.demux_gates.G1n.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.demux_gates.G1p.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.demux_gates.G2", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "G2", }, {
    "Inverter1.converter_Xabc.demux_gates.G2n.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.demux_gates.G2p.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.demux_gates.G3", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "G3", }, {
    "Inverter1.converter_Xabc.demux_gates.G3n.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.demux_gates.G3p.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.demux_gates.G4", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "G4", }, {
    "Inverter1.converter_Xabc.demux_gates.G4n.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.demux_gates.G4p.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.demux_gates.G5", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "G5", }, {
    "Inverter1.converter_Xabc.demux_gates.G5n.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.demux_gates.G5p.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.demux_gates.G6", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "G6", }, {
    "Inverter1.converter_Xabc.demux_gates.G6n.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.demux_gates.G6p.v", "Robot/Inverter1", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.converter_Xabc.demux_gates.I", "Robot/Inverter1", 1U, 12U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, {
    "Inverter1.converter_Xabc.demux_gates.i1n", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i1n", }, {
    "Inverter1.converter_Xabc.demux_gates.i1p", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i1p", }, {
    "Inverter1.converter_Xabc.demux_gates.i2n", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i2n", }, {
    "Inverter1.converter_Xabc.demux_gates.i2p", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i2p", }, {
    "Inverter1.converter_Xabc.demux_gates.i3n", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i3n", }, {
    "Inverter1.converter_Xabc.demux_gates.i3p", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i3p", }, {
    "Inverter1.converter_Xabc.demux_gates.i4n", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i4n", }, {
    "Inverter1.converter_Xabc.demux_gates.i4p", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i4p", }, {
    "Inverter1.converter_Xabc.demux_gates.i5n", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i5n", }, {
    "Inverter1.converter_Xabc.demux_gates.i5p", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i5p", }, {
    "Inverter1.converter_Xabc.demux_gates.i6n", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i6n", }, {
    "Inverter1.converter_Xabc.demux_gates.i6p", "Robot/Inverter1", 1U, 1U, "A",
    1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i6p", }, {
    "Inverter1.converter_Xabc.demux_gates.p.V", "Robot/Inverter1", 1U, 12U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", }, { "Inverter1.converter_Xabc.n.v",
    "Robot/Inverter1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage",
  }, { "Inverter1.converter_Xabc.p.v", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Inverter1.n.v",
    "Robot/Inverter1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage",
  }, { "Inverter1.p.v", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.phase_splitter.I", "Robot/Inverter1", 1U, 3U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, { "Inverter1.phase_splitter.N.V",
    "Robot/Inverter1", 1U, 3U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", },
    { "Inverter1.phase_splitter.a.v", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.phase_splitter.b.v", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.phase_splitter.c.v", "Robot/Inverter1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Inverter1.phase_splitter.i_a", "Robot/Inverter1", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i_a", }, {
    "Inverter1.phase_splitter.i_b", "Robot/Inverter1", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i_b", }, {
    "Inverter1.phase_splitter.i_c", "Robot/Inverter1", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i_c", }, { "MRRef_IPMSM1.W.w",
    "Robot/MRRef IPMSM1", 1U, 1U, "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Rotational velocity", }, { "Meas_V1.Voltage_Sensor.V",
    "Robot/Meas V1/Voltage Sensor", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", }, { "Meas_V1.Voltage_Sensor.i1",
    "Robot/Meas V1/Voltage Sensor", 1U, 1U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "Meas_V1.Voltage_Sensor.n.v", "Robot/Meas V1/Voltage Sensor", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Meas_V1.Voltage_Sensor.p.v", "Robot/Meas V1/Voltage Sensor", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Meas_V1.Voltage_Sensor.v1", "Robot/Meas V1/Voltage Sensor", 1U, 1U, "V",
    1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "Meas_V1.x0.v",
    "Robot/Meas V1", 1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, TRUE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Voltage", }, { "Meas_V1.x1.v", "Robot/Meas V1", 1U, 1U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Voltage", }, { "Motion_Sensor1.A",
    "Robot/Motion  Sensor1", 1U, 1U, "rad", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "A", },
    { "Motion_Sensor1.C.w", "Robot/Motion  Sensor1", 1U, 1U, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Motion_Sensor1.R.w", "Robot/Motion  Sensor1", 1U, 1U, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Motion_Sensor1.W", "Robot/Motion  Sensor1", 1U, 1U, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "W", }, { "Motion_Sensor1.phi",
    "Robot/Motion  Sensor1", 1U, 1U, "deg", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED,
    NE_INIT_MODE_MANDATORY, FALSE, TRUE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Angle", }, { "Motion_Sensor1.t", "Robot/Motion  Sensor1", 1U, 1U, "N*m",
    1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, { "Motion_Sensor1.w",
    "Robot/Motion  Sensor1", 1U, 1U, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Angular velocity", }, {
    "Sensing_iabc1.Current_Sensor.I", "Robot/Sensing  iabc1/Current Sensor", 1U,
    3U, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, {
    "Sensing_iabc1.Current_Sensor.I_output",
    "Robot/Sensing  iabc1/Current Sensor", 1U, 3U, "A", 1.0, "A",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "I", }, {
    "Sensing_iabc1.Current_Sensor.N1.V", "Robot/Sensing  iabc1/Current Sensor",
    1U, 3U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", }, {
    "Sensing_iabc1.Current_Sensor.N2.V", "Robot/Sensing  iabc1/Current Sensor",
    1U, 3U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", }, { "Sensing_iabc1.x1.V",
    "Robot/Sensing  iabc1", 1U, 3U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "V", },
  { "Sensing_iabc1.x2.V", "Robot/Sensing  iabc1", 1U, 3U, "V", 1.0, "V",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "V", }, { "Torque_Sensor1.C.w",
    "Robot/Torque Sensor1", 1U, 1U, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Torque_Sensor1.R.w", "Robot/Torque Sensor1", 1U, 1U, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "Torque_Sensor1.T", "Robot/Torque Sensor1", 1U, 1U, "N*m", 1.0, "N*m",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "T", }, { "Torque_Sensor1.t",
    "Robot/Torque Sensor1", 1U, 1U, "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL,
    NE_INIT_MODE_NONE, FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque",
  }, { "Torque_Sensor1.w", "Robot/Torque Sensor1", 1U, 1U, "rad/s", 1.0, "1/s",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Angular velocity", } };

static NeModeData *s_major_mode_data = NULL;
static NeZCData s_zc_data[27] = { { "Robot/Inverter1", 1U, 0U,
    "Inverter1.converter_Xabc.Q5.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 1U,
    "Inverter1.converter_Xabc.Q5.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 2U,
    "Inverter1.converter_Xabc.Q5.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 3U,
    "Inverter1.converter_Xabc.Q4.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 4U,
    "Inverter1.converter_Xabc.Q4.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 5U,
    "Inverter1.converter_Xabc.Q6.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 6U,
    "Inverter1.converter_Xabc.Q4.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 7U,
    "Inverter1.converter_Xabc.Q3.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 8U,
    "Inverter1.converter_Xabc.Q3.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 9U,
    "Inverter1.converter_Xabc.Q2.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 10U,
    "Inverter1.converter_Xabc.Q3.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 11U,
    "Inverter1.converter_Xabc.Q1.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 12U,
    "Inverter1.converter_Xabc.Q6.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/BLDC1", 1U, 13U, "BLDC1.pm_dq0_Xabc",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/+pm_rotor/+bldc/Xabc.sscp",
    NE_ZC_TYPE_TRUE, }, { "Robot/BLDC1", 1U, 14U, "BLDC1.pm_dq0_Xabc",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/+pm_rotor/+bldc/Xabc.sscp",
    NE_ZC_TYPE_TRUE, }, { "Robot/Inverter1", 1U, 15U,
    "Inverter1.converter_Xabc.Q1.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 16U,
    "Inverter1.converter_Xabc.Q5.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    NE_ZC_TYPE_TRUE, }, { "Robot/Inverter1", 1U, 17U,
    "Inverter1.converter_Xabc.Q6.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    NE_ZC_TYPE_TRUE, }, { "Robot/Inverter1", 1U, 18U,
    "Inverter1.converter_Xabc.Q3.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    NE_ZC_TYPE_TRUE, }, { "Robot/BLDC1", 1U, 19U, "BLDC1.pm_dq0_Xabc",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/+pm_rotor/+bldc/Xabc.sscp",
    NE_ZC_TYPE_TRUE, }, { "Robot/Inverter1", 1U, 20U,
    "Inverter1.converter_Xabc.Q2.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 21U,
    "Inverter1.converter_Xabc.Q2.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 22U,
    "Inverter1.converter_Xabc.Q4.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    NE_ZC_TYPE_TRUE, }, { "Robot/Inverter1", 1U, 23U,
    "Inverter1.converter_Xabc.Q2.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    NE_ZC_TYPE_TRUE, }, { "Robot/Inverter1", 1U, 24U,
    "Inverter1.converter_Xabc.Q1.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 25U,
    "Inverter1.converter_Xabc.Q6.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    NE_ZC_TYPE_FALSE, }, { "Robot/Inverter1", 1U, 26U,
    "Inverter1.converter_Xabc.Q1.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    NE_ZC_TYPE_TRUE, } };
...
static NeAssertData s_assert_data[42] = { { "Robot/BLDC1", 1U, 0U,
    "BLDC1.pm_dq0_Xabc",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/+pm_rotor/+bldc/Xabc.sscp",
    TRUE,
    "In power, the exponent should be positive when the base is equal to zero. This may become error in future releases.",
    "physmod:common:mf:core:asserts:RequireExponentPositive", }, { "Robot/BLDC1",
    1U, 1U, "BLDC1.pm_dq0_Xabc",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/+pm_rotor/+bldc/Xabc.sscp",
    TRUE,
    "In power, the base should be nonnegative when the exponent is not an integer. This may become error in future releases.",
    "physmod:common:mf:core:asserts:RequireBaseNonnegative", }, { "Robot/BLDC1",
    1U, 2U, "BLDC1.pm_dq0_Xabc",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/+pm_rotor/+bldc/Xabc.sscp",
    TRUE,
    "In power, the exponent should be positive when the base is equal to zero. This may become error in future releases.",
    "physmod:common:mf:core:asserts:RequireExponentPositive", }, { "Robot/BLDC1",
    1U, 3U, "BLDC1.pm_dq0_Xabc",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/+pm_rotor/+bldc/Xabc.sscp",
    TRUE,
    "In power, the base should be nonnegative when the exponent is not an integer. This may become error in future releases.",
    "physmod:common:mf:core:asserts:RequireBaseNonnegative", }, { "Robot/BLDC1",
    1U, 4U, "BLDC1.pm_dq0_Xabc",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/+pm_rotor/+bldc/Xabc.sscp",
    TRUE,
    "In power, the exponent should be positive when the base is equal to zero. This may become error in future releases.",
    "physmod:common:mf:core:asserts:RequireExponentPositive", }, { "Robot/BLDC1",
    1U, 5U, "BLDC1.pm_dq0_Xabc",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+electromech/+pmsm/+pm_rotor/+bldc/Xabc.sscp",
    TRUE,
    "In power, the base should be nonnegative when the exponent is not an integer. This may become error in future releases.",
    "physmod:common:mf:core:asserts:RequireBaseNonnegative", }, {
    "Robot/Inverter1", 1U, 6U, "Inverter1.converter_Xabc.Q1.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 7U, "Inverter1.converter_Xabc.Q1.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 8U, "Inverter1.converter_Xabc.Q1.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 9U, "Inverter1.converter_Xabc.Q1.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 10U, "Inverter1.converter_Xabc.Q1.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 11U, "Inverter1.converter_Xabc.Q1.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 12U, "Inverter1.converter_Xabc.Q2.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 13U, "Inverter1.converter_Xabc.Q2.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 14U, "Inverter1.converter_Xabc.Q2.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 15U, "Inverter1.converter_Xabc.Q2.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 16U, "Inverter1.converter_Xabc.Q2.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 17U, "Inverter1.converter_Xabc.Q2.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 18U, "Inverter1.converter_Xabc.Q3.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 19U, "Inverter1.converter_Xabc.Q3.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 20U, "Inverter1.converter_Xabc.Q3.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 21U, "Inverter1.converter_Xabc.Q3.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 22U, "Inverter1.converter_Xabc.Q3.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 23U, "Inverter1.converter_Xabc.Q3.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 24U, "Inverter1.converter_Xabc.Q4.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 25U, "Inverter1.converter_Xabc.Q4.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 26U, "Inverter1.converter_Xabc.Q4.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 27U, "Inverter1.converter_Xabc.Q4.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 28U, "Inverter1.converter_Xabc.Q4.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 29U, "Inverter1.converter_Xabc.Q4.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 30U, "Inverter1.converter_Xabc.Q5.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 31U, "Inverter1.converter_Xabc.Q5.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 32U, "Inverter1.converter_Xabc.Q5.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 33U, "Inverter1.converter_Xabc.Q5.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 34U, "Inverter1.converter_Xabc.Q5.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 35U, "Inverter1.converter_Xabc.Q5.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 36U, "Inverter1.converter_Xabc.Q6.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 37U, "Inverter1.converter_Xabc.Q6.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 38U, "Inverter1.converter_Xabc.Q6.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 39U, "Inverter1.converter_Xabc.Q6.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 40U, "Inverter1.converter_Xabc.Q6.diode",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/diode_base.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", }, {
    "Robot/Inverter1", 1U, 41U, "Inverter1.converter_Xabc.Q6.ideal_switch",
    "C:/Program Files/MATLAB/R2020a/toolbox/physmod/elec/library/m/+ee/+semiconductors/+igbt/igbt_equation.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:core:asserts:RequireDenominatorNonzero", } };
...
NeDynamicSystem *Robot_d2dba219_3_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  ...
  input_info[0].mIdentifier = "Ideal_Angular_Velocity_Source1.S";
  input_info[0].mM = 1;
  input_info[0].mN = 1;
  input_info[0].mName = "Ideal_Angular_Velocity_Source1.S";
  input_info[0].mUnit = "rad/s";
  input_info[1].mIdentifier = "Gate_driver1.Six_Pulse_Gate_Multiplexer.GaH";
  input_info[1].mM = 1;
  input_info[1].mN = 1;
  input_info[1].mName = "Gate_driver1.Six_Pulse_Gate_Multiplexer.GaH";
  input_info[1].mUnit = "V";
  input_info[2].mIdentifier = "Gate_driver1.Six_Pulse_Gate_Multiplexer.GaL";
  input_info[2].mM = 1;
  input_info[2].mN = 1;
  input_info[2].mName = "Gate_driver1.Six_Pulse_Gate_Multiplexer.GaL";
  input_info[2].mUnit = "V";
  input_info[3].mIdentifier = "Gate_driver1.Six_Pulse_Gate_Multiplexer.GbH";
  input_info[3].mM = 1;
  input_info[3].mN = 1;
  input_info[3].mName = "Gate_driver1.Six_Pulse_Gate_Multiplexer.GbH";
  input_info[3].mUnit = "V";
  input_info[4].mIdentifier = "Gate_driver1.Six_Pulse_Gate_Multiplexer.GbL";
  input_info[4].mM = 1;
  input_info[4].mN = 1;
  input_info[4].mName = "Gate_driver1.Six_Pulse_Gate_Multiplexer.GbL";
  input_info[4].mUnit = "V";
  input_info[5].mIdentifier = "Gate_driver1.Six_Pulse_Gate_Multiplexer.GcH";
  input_info[5].mM = 1;
  input_info[5].mN = 1;
  input_info[5].mName = "Gate_driver1.Six_Pulse_Gate_Multiplexer.GcH";
  input_info[5].mUnit = "V";
  input_info[6].mIdentifier = "Gate_driver1.Six_Pulse_Gate_Multiplexer.GcL";
  input_info[6].mM = 1;
  input_info[6].mN = 1;
  input_info[6].mName = "Gate_driver1.Six_Pulse_Gate_Multiplexer.GcL";
  input_info[6].mUnit = "V";
  ds->mIo[NE_INPUT_IO_TYPE] = input_info;
  ds->mNumIo[NE_OUTPUT_IO_TYPE] = 4;
  output_info[0].mIdentifier = "Meas_V1.Voltage_Sensor.V";
  output_info[0].mM = 1;
  output_info[0].mN = 1;
  output_info[0].mName = "Meas_V1.Voltage_Sensor.V";
  output_info[0].mUnit = "V";
  output_info[1].mIdentifier = "Motion_Sensor1.A";
  output_info[1].mM = 1;
  output_info[1].mN = 1;
  output_info[1].mName = "Motion_Sensor1.A";
  output_info[1].mUnit = "rad";
  output_info[2].mIdentifier = "Sensing_iabc1.Current_Sensor.I_output";
  output_info[2].mM = 1;
  output_info[2].mN = 3;
  output_info[2].mName = "Sensing_iabc1.Current_Sensor.I_output";
  output_info[2].mUnit = "A";
  output_info[3].mIdentifier = "Torque_Sensor1.T";
  output_info[3].mM = 1;
  output_info[3].mN = 1;
  output_info[3].mName = "Torque_Sensor1.T";
  ...
  ds->mMethods[NE_DS_METHOD_M_P] = Robot_d2dba219_3_ds_m_p;
  ...
  ds->mMethods[NE_DS_METHOD_A_P] = Robot_d2dba219_3_ds_a_p;
  ...
  ds->mMethods[NE_DS_METHOD_F] = Robot_d2dba219_3_ds_f;
  ...
  ds->mMethods[NE_DS_METHOD_DXF_P] = Robot_d2dba219_3_ds_dxf_p;
  ds->mMakeOutput[NE_DS_METHOD_DXF_P] = ds_output_dxf_p;
  ds->mMethods[NE_DS_METHOD_DXF] = Robot_d2dba219_3_ds_dxf;
  ...
  ds->mMethods[NE_DS_METHOD_DUF] = Robot_d2dba219_3_ds_duf;
  ...
  ds->mMethods[NE_DS_METHOD_DTF] = Robot_d2dba219_3_ds_dtf;
  ...
  ds->mMethods[NE_DS_METHOD_TDXF_P] = Robot_d2dba219_3_ds_tdxf_p;
  ds->mMakeOutput[NE_DS_METHOD_TDXF_P] = ds_output_tdxf_p;
  ds->mMethods[NE_DS_METHOD_DNF_P] = Robot_d2dba219_3_ds_dnf_p;
  ...
  ds->mMethods[NE_DS_METHOD_TDXY_P] = Robot_d2dba219_3_ds_tdxy_p;
  ...
  ds->mMethods[NE_DS_METHOD_DXY_P] = Robot_d2dba219_3_ds_dxy_p;
  ...
  ds->mMethods[NE_DS_METHOD_MODE] = Robot_d2dba219_3_ds_mode;
  ds->mMakeOutput[NE_DS_METHOD_MODE] = ds_output_mode;
  ds->mMethods[NE_DS_METHOD_ZC] = Robot_d2dba219_3_ds_zc;
  ...
  ds->mMethods[NE_DS_METHOD_LOG] = Robot_d2dba219_3_ds_log;
  ds->mMakeOutput[NE_DS_METHOD_LOG] = ds_output_log;
  ds->mMethods[NE_DS_METHOD_ASSERT] = Robot_d2dba219_3_ds_assert;
  ...
  ds->mMethods[NE_DS_METHOD_OBS_EXP] = Robot_d2dba219_3_ds_obs_exp;
  ds->mMakeOutput[NE_DS_METHOD_OBS_EXP] = ds_output_obs_exp;
  ds->mMethods[NE_DS_METHOD_OBS_ACT] = Robot_d2dba219_3_ds_obs_act;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ACT] = ds_output_obs_act;
  ds->mMethods[NE_DS_METHOD_OBS_ALL] = Robot_d2dba219_3_ds_obs_all;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ALL] = ds_output_obs_all;
  ds->mMethods[NE_DS_METHOD_OBS_IL] = Robot_d2dba219_3_ds_obs_il;
