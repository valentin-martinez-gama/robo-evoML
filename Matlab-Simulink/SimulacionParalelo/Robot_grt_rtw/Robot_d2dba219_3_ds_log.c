...
int32_T Robot_d2dba219_3_ds_log(const NeDynamicSystem *t0, const
  NeDynamicSystemInput *t65, NeDsMethodOutput *t66)
{
  ...
  t7[55ULL] = 0.0;
  for (t33 = 0ULL; t33 < 12ULL; t33++) {
    t7[t33 + 56ULL] = Gate_driver1_G_V[t33];
  }
  ...
  for (t33 = 0ULL; t33 < 12ULL; t33++) {
    t7[t33 + 86ULL] = Gate_driver1_G_V[t33];
  }

  t7[98ULL] = BLDC1_pm_dq0_Xabc_i_n;
  t7[99ULL] = X_idx_11;
  t7[100ULL] = 0.0;
  t7[101ULL] = BLDC1_pm_dq0_Xabc_i_n * 1.0E+9;
  t7[102ULL] = 0.0;
  t7[103ULL] = U_idx_0;
  t7[104ULL] = U_idx_0;
  t7[105ULL] = X_idx_14;
  t7[106ULL] = U_idx_0;
  for (t33 = 0ULL; t33 < 12ULL; t33++) {
    t7[t33 + 107ULL] = Gate_driver1_G_V[t33];
  }
  ...
  t7[121ULL] = X_idx_10;
  for (t33 = 0ULL; t33 < 12ULL; t33++) {
    t7[t33 + 122ULL] = Gate_driver1_G_V[t33];
  }
  ...
  t7[136ULL] = U_idx_1;
  t7[137ULL] = 298.15;
  t7[138ULL] = Inverter1_converter_Xabc_Q1_diode_i;
  t7[139ULL] = 0.0;
  t7[140ULL] = 24.0;
  t7[141ULL] = X_idx_8;
  t7[142ULL] = -(Inverter1_converter_Xabc_Q1_diode_i * (X_idx_8 + -24.0) * 0.001)
    / -1.0 * 1000.0;
  ...
  t7[172ULL] = U_idx_3;
  t7[173ULL] = 298.15;
  t7[174ULL] = Inverter1_converter_Xabc_Q3_diode_i;
  t7[175ULL] = 0.0;
  t7[176ULL] = 24.0;
  t7[177ULL] = X_idx_9;
  t7[178ULL] = -(Inverter1_converter_Xabc_Q3_diode_i * (X_idx_9 + -24.0) * 0.001)
    / -1.0 * 1000.0;
  ...
  t7[208ULL] = U_idx_5;
  t7[209ULL] = 298.15;
  t7[210ULL] = Inverter1_converter_Xabc_Q5_diode_i;
  t7[211ULL] = 0.0;
  t7[212ULL] = 24.0;
  t7[213ULL] = X_idx_10;
  t7[214ULL] = -(Inverter1_converter_Xabc_Q5_diode_i * (X_idx_10 + -24.0) *
                 0.001) / -1.0 * 1000.0;
  ...
  t7[286ULL] = 0.0;
  for (t33 = 0ULL; t33 < 12ULL; t33++) {
    t7[t33 + 287ULL] = Gate_driver1_G_V[t33];
  }
