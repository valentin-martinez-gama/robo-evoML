...
class greek_Model:
    ...
    def I_am(self):
        print("I am Greek")
        self.am = 'A greek model, the son of the original Alpha, Beta and Gamma iterations, Valen creation'
    plot = False
    ...
    def build_ML_training_set(self, group_size=10, data_dir='Datasets/'):
        ...
        with open(data_dir+in_file, 'r') as json_file:
            for evolution in json_file:
                ...
                for individual in evo_data['runs_data']: #generation:evo_data['runs_data']
