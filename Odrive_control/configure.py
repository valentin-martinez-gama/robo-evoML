...
def independent_gains(odrv, gains_A0=[20, .16, .32], gains_A1=[20, .16, .32]):
    odrv.axis0.controller.config.pos_gain = gains_A0[0]  # [(turns/s) / turns]
    odrv.axis0.controller.config.vel_gain = gains_A0[1]  # [Nm/(turns/s)]
    odrv.axis0.controller.config.vel_integrator_gain = gains_A0[2]  # [Nm/((turns/s) * s)]
